...
(
    ...
    -- below from Postgres
    name             VARCHAR2(100) NOT NULL, -- название специальности -- 09.03.04 – Разработка программно-информационных систем (Академический магистр)
    educational_form VARCHAR2(100) NOT NULL, -- форма обучения -- очная/заочная
    standard         VARCHAR2(10)  NOT NULL, -- тип стандарта обучения -- старый/новый
...
(
    ...
    name              VARCHAR2(100) NOT NULL, -- название дисциплины -- Компьютерная графика (2018449043-И)
    department_id     INTEGER       NOT NULL REFERENCES department (department_id), /* общее поле для Oracle и Postgres */
    -- below from Postgres
